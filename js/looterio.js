/* LOOTERIO on the landing: the search engine's own logo, drawn the same way */
(function(){
function quickSearch(q){qry=q;document.getElementById('resultsInput').value=q;pg=1;render();}
...
function darken(hex, pct) {
  ...
  var go=function(){ drawLogo(c, 40); };
  if (document.fonts && document.fonts.load) document.fonts.load('bold 40px "Lobster Two"').then(go, go); else go();
})();
