...
const PRODUCTS = [
  ...
  { id: 'cult',   cat: ['apparel', 'custom'],  tile: 'cult',  img: 'assets/illuminati.jpg', title: 'ILLUMINATI MEMBERSHIP. apparel. no refunds', price: 4.20, note: 'soon' },
  { id: 'cherry', cat: ['capital', 'custom', 'art'], tile: 'cherry', img: 'assets/cherry-cupid.jpg', title: 'CHERRY BOMB · model management · independent models only', priceLabel: '฿?', note: 'soon' },
  ...
  { id: 'club',   cat: ['events', 'capital'],  tile: 'club',  img: 'assets/voodoo.jpg', seized: true, title: 'VOODOO B.C · beach club, Saint-Tropez style', priceLabel: 'SEIZED BY LooterStudio®', note: 'soon' },
