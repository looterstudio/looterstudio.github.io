...
const PRODUCTS = [
  ...
  { id: 'louvre',   cat: ['software', 'custom', 'capital'], tile: 'louvre', img: 'assets/luv-tile.png', title: 'LUV Agency. the works', priceLabel: '฿?', note: 'works', link: 'https://looterstudio.xyz/luv/' },
  { id: 'terminator', cat: ['software', 'bots', 'capital'], tile: 'terminator', text: '', title: 'TERMINATOR EXPERIMENT. an AI that pays for its own existence, or dies', priceLabel: '฿?', note: 'experiment', link: 'https://github.com/looterstudio/terminator' },
