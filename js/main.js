...
const PRODUCTS = [
  ...
  { id: 'terminator', cat: ['software', 'bots', 'capital'], tile: 'terminator', text: '', title: 'TERMINATOR EXPERIMENT. an AI that pays for its own existence, or dies', priceLabel: '฿?', note: 'experiment', link: 'terminator/' },
